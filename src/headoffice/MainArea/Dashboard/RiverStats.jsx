    ...
    <RiverStatsStyled>
      ...
      <CardWrapper>
        ...
        <Card
          ...
          onClick = {() => {history.push(`/headoffice/idone_factory/${name}`)}}
        />
      </CardWrapper>
    </RiverStatsStyled>
  );
